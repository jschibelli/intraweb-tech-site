---
title: End-to-End Issue to Merge Workflow
owner: automation
version: 0.1.0
last_reviewed: 2025-11-15
linked_scripts:
  - scripts/automation/create-issue-enhanced.ps1
  - scripts/automation/continuous-issue-pipeline.ps1
  - scripts/automation/issue-queue-manager.ps1
  - scripts/automation/agent-status-update.ps1
...
7. **Status Update**: Set issue to **"In review"** (work complete, PR being reviewed) on project board using `agent-status-update.ps1`
...
- **Backlog**  **Ready** (when issue is assigned)
- **Ready**  **In progress** (when work starts)
- **In progress**  **In review** (when PR is created)
- **In review**  **Done** (when PR is merged successfully)
