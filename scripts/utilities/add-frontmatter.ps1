...
$filesToFix = @(
    ...
    @{ Path = "apps\docs\contents\docs\getting-started\user-guide\index.mdx"; Title = "User Guide"; Description = "Guide for using Workant" },
    @{ Path = "apps\docs\contents\docs\developer-guide\overview\index.mdx"; Title = "Developer Guide"; Description = "Complete developer guide for Workant" },
