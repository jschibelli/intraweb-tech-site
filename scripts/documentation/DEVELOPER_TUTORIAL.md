...
.\scripts\automation\assign-pr-agents.ps1 -ProjectNumber 20
...
.\scripts\automation\auto-configure-pr.ps1 -PRNumber 123 -Priority "P1" -Size "L"
```
...
```powershell
.\scripts\automation\auto-configure-pr.ps1 -PRNumber <PR_NUMBER>
```
```
