...
.\scripts\automation\assign-pr-agents.ps1 -DryRun

# Configure PR settings
.\scripts\automation\auto-configure-pr.ps1 -PRNumber 123 -Priority "P1" -Size "M"
...
### **🌿 Branch Automation**
```powershell
# Audit local + remote branches, export report
pwsh scripts/branch-management/branch-health-audit.ps1 -Scope all -ReportPath reports/branch-health.json

# Sync current branch via rebase, push with force-with-lease
pwsh scripts/branch-management/sync-feature-branch.ps1 -Strategy rebase -Push -ForceWithLease -TestCommand "pnpm lint"

# Batch-create branches for docs preset
pwsh scripts/branch-management/batch-branch-orchestrator.ps1 -Preset docs -Push -ReportPath reports/docs-batch.json
```
...
# 2. Configure PR
.\scripts\automation\auto-configure-pr.ps1 -PRNumber 123
...
| **PR Management** | `scripts/automation/` | `assign-pr-agents.ps1`, `auto-configure-pr.ps1`, `pr-automation-unified.ps1` |
| **Branch Automation** | `branch-management/` | `branch-health-audit.ps1`, `sync-feature-branch.ps1`, `batch-branch-orchestrator.ps1` |
