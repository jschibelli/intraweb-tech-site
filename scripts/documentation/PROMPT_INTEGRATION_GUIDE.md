...
```powershell
.\scripts\automation\auto-configure-pr.ps1 -PRNumber <PR_NUMBER> -Priority "P1" -Size "M"
```
...
```powershell
.\scripts\automation\auto-configure-pr.ps1 -PRNumber 456 -Priority "P1" -Size "L"
```
...
2. **Configure PR Settings:**
```powershell
.\scripts\automation\auto-configure-pr.ps1 -PRNumber [PR_NUMBER] -Priority "[PRIORITY]" -Size "[SIZE]"
```
