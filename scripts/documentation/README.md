...
- `automation/assign-pr-agents.ps1` - PR assignment
- `automation/auto-configure-pr.ps1` - PR configuration
- `automation/pr-automation-unified.ps1` - AI-driven workflow
- `pr-management/get-pr-aliases.ps1` - Legacy PR aliases
...
### **🌿 Branch Automation**
Git workflow guardrails and helpers:
- `branch-health-audit.ps1` - Detect stale or drifting branches, export reports
- `sync-feature-branch.ps1` - Rebase/merge feature branches onto develop with push/test automation
- `batch-branch-orchestrator.ps1` - Bulk-create/push branches from presets or JSON configs
- `branch-utils.psm1` - Shared naming, GitHub issue fetch, and git wrapper module
