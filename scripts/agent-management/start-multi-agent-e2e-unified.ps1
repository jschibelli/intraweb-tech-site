...
function Show-AgentE2ECommands {
    ...
    switch ($Mode) {
        "continuous" {
            ...
            Write-ColorOutput ".\scripts\issue-management\management\continuous-issue-pipeline.ps1 -MaxIssues $($agent.MaxIssues) -Agent '$AgentKey' -Queue '$($agent.Queue)' -Watch" "Gray"
            Write-ColorOutput ""
