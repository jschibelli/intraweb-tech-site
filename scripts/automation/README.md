...
## 📍 **Note: Scripts Reorganized (2025-01-27)**

As part of a consolidation effort, issue management, PR management, and project management scripts have been moved to their respective specialized folders:

- **Issue Management Scripts** → `scripts/issue-management/`
- **PR Management Scripts** → `scripts/pr-management/`
- **Project Management Scripts** → `scripts/project-management/`

This folder now contains only shared utilities and documentation. See `CONSOLIDATION_COMPLETE.md` for details.
...
#   - management/continuous-issue-pipeline.ps1
