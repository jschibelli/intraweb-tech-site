...
Write-Host "Priority: $Priority, Size: $Size" -ForegroundColor Yellow

$result = Set-IssueConfiguration -IssueNumber $IssueNumber -Priority $Priority -Size $Size -Estimate $Estimate -Milestone $Milestone -Labels $Labels
