...
export const metadata = {
  ...
  description:
    "Terms and conditions governing use of IntraWeb Technologies website and services.",
  alternates: {
...
export default function TermsOfServicePage() {
  return (
    ...
    >
      ...
      <p>
        These Terms of Service (&ldquo;Terms&rdquo;) constitute a legally binding agreement between you (&ldquo;you&rdquo; or &ldquo;your&rdquo;) and IntraWeb Technologies LLC (&ldquo;IntraWeb,&rdquo; &ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) governing your access to and use of the intrawebtech.com website and any related services.
      </p>
      <p>
      ...
      <p>IntraWeb Technologies provides operational consulting services, including:</p>
      <ul>
        <li>Agent Readiness Diagnostic assessments</li>
        <li>Implementation retainer services for workflow automation</li>
      ...
      <h2 id="client-services">Client Services</h2>
      ...
      <ul>
        <li>Access to relevant systems, personnel, and documentation</li>
        <li>Prompt responses to requests for information</li>
        <li>Feedback on deliverables within agreed timeframes</li>
        <li>Designated point of contact with decision-making authority</li>
      </ul>
      <p>
      ...
      <h3>Payment Terms</h3>
      <p>Fees for services are specified in your service agreement. Unless otherwise stated:</p>
      <ul>
        <li>Diagnostic fees are due upon contract execution</li>
        <li>Retainer fees are due on the first of each month</li>
      ...
      <p>
        OUR WEBSITE AND SERVICES ARE PROVIDED &ldquo;AS IS&rdquo; WITHOUT WARRANTY OF ANY KIND. WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, INCLUDING WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT.
      </p>
      <p>
      ...
      <p>
        ...
        <a href="mailto:legal@intrawebtech.com">legal@intrawebtech.com</a>{" "}
      ...
      <h3>Notices</h3>
      <p>
        Notices to IntraWeb must be sent to{" "}
        <a href="mailto:legal@intrawebtech.com">legal@intrawebtech.com</a>.{" "}
        We may provide notices to you via the email address you provided or by posting on our website.
      </p>
      ...
      <p>
        Material changes will be noted with an updated &ldquo;Last updated&rdquo; date at the top of this page.
      </p>
